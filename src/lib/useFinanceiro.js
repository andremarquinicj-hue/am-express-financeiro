...
export function useFinanceiro() {
  ...
  const removerValorDoRecebivel = useCallback((rota, listaRecebiveisAtual) => {
    ...
    return listaRecebiveisAtual
      ...
      // Não remove recebíveis zerados automaticamente — o usuário pode ter excluído
      // uma rota errada e precisa ver o recebível pra entender o estado. Recebíveis
      // com valor zero ficam visíveis com badge "A RECEBER R$ 0,00" e somem apenas
      // quando o usuário confirmar recebimento ou excluir manualmente pelo drill-down.
      ;
  }, []);
